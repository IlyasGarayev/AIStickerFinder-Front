...
// In a real scenario, this might come from an env var, but the prompt specifies localhost:8000
...
// However, the prompt explicitly says "The backend is at http://localhost:8000".
...
// Assuming the user has a backend running on port 8000 in the same environment 
